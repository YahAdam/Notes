...
export function NotePad({ theme, setTheme }: NotePadProps) {
  ...
  const [currentTextColor, setCurrentTextColor] = useState("var(--text)");
  ...
  useEffect(() => {
    ...
    const syncTextColor = () => {
      ...
      setCurrentTextColor(
        typeof color === "string" && color ? color : "var(--text)",
      );
    };
